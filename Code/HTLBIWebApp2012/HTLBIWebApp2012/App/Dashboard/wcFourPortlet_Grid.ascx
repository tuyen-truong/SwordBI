<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wcFourPortlet_Grid.ascx.cs" Inherits="HTLBIWebApp2012.App.Dashboard.wcFourPortlet_Grid" %>
...
<div id="palDashboards" class="box-4zone-container" style="margin-top:5px;">
    ...
    <div id="portlet3" class="boxed box-bottomleft">
        <center class="title">
            <asp:ImageButton  runat="server" ID="imgBtnSetting_portlet3"            
                ImageUrl="~/Content/Images/setting_16.png" ToolTip="Setting." ImageAlign="Right" 
                OnClientClick="Set_ProcessState('0');" CommandArgument="1" 
                CommandName="Setting" oncommand="imgBtn_Command"/>
            <dx:ASPxLabel ID="lblTitle_portlet3" runat="server" Text=""></dx:ASPxLabel>                
        </center>
        <div class="content">
            <div id="container_Pl3_Param" runat="server" style="width:100%" ></div>
            <center>                
                <div id="container_Pl3" runat="server" style="width:100%" ></div>
            </center>
        </div>
    </div>
    <div id="portlet4" class="boxed box-bottomright">
        <center class="title">
            <asp:ImageButton  runat="server" ID="imgBtnSetting_portlet4"            
                ImageUrl="~/Content/Images/setting_16.png" ToolTip="Setting." ImageAlign="Right" 
                OnClientClick="Set_ProcessState('0');" CommandArgument="1" 
                CommandName="Setting" oncommand="imgBtn_Command"/>
            <dx:ASPxLabel ID="lblTitle_portlet4" runat="server" Text=""></dx:ASPxLabel>                
        </center>
        <div class="content">
            <div id="container_Pl4_Param" runat="server" style="width:100%" ></div>
            <center>
                <div id="container_Pl4" runat="server" style="width:100%" ></div>
            </center>
        </div>
    </div>
</div>