<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wcThreePortlet_Flow.ascx.cs" Inherits="HTLBIWebApp2012.App.Dashboard.wcThreePortlet_Flow" %>
...
<div id="palDashboards" class="box-4zone-container" style="margin-top:5px;">
    ...
    <div id="portlet3_bufferLeft" class="boxed box-bottomleft" style="visibility:hidden"></div>
