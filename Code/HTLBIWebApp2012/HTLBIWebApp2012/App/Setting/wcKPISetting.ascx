<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wcKPISetting.ascx.cs"
    Inherits="HTLBIWebApp2012.App.Setting.wcKPISetting" %>
...
<script language="javascript" type="text/javascript">
    ...
    function BtnSave_Click(s, e) {
        var errMsg = '';
        var kpiCode = typeof (Get_CurKPICode) == 'undefined' ? '' : Get_CurKPICode();
        if (typeof (Get_CurDSCode) == 'undefined') {
            Get_CurDSCode = function () {
                var el = document.getElementById('ctl00_ctl00_bodyContent_MainContent_ctl00_cbp_Header_TrDataSource');
                if (el) {
                    var ret = KPI_cboDatasource.GetValue();
                    return (ret == null) ? '' : ret.toString();
                }
                var v = $('KPISetting_DSCode').val();
                console.log(v);
                return v == null ? '' : v;
        ...
        {
            errMsg = 'Please select a datasource.';
            if (typeof (Portlet_SetActiveTab) != 'undefined') {
    ...
    // btnPreview
    function BtnPreview_Click(s, e) {
        var errMsg = '';
        var kpiCode = typeof (Get_CurKPICode) == 'undefined' ? '' : Get_CurKPICode();
        if (typeof (Get_CurDSCode) == 'undefined') {
            Get_CurDSCode = function () {
                var el = $('#ctl00_ctl00_bodyContent_MainContent_ctl00_cbp_Header_TrDataSource');
                if (el.length > 0) {
                    var ret = KPI_cboDatasource.GetValue();
                    return (ret == null) ? '' : ret.toString();
                }
...
<style type="text/css">
    ...
    .ds{border-spacing: 0; border-collapse:collapse;}
    .ds th{width:117px; font-weight: normal !important; padding:3px 0 3px 0 !important;}
</style>
<table>
    <tr>
        <td colspan="4" class="titleBox_AgLeft">
            KPI DEFINATION
        </td>
    </tr>
</table>
...
<fieldset style="padding: 3px">
    ...
    <dx:ASPxCallbackPanel ID="cbp_Header" ClientInstanceName="KPI_cbp_Header" runat="server"
        Width="100%" OnCallback="cbp_Callback">
        <PanelCollection>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 250px;">
                                    <dx:ASPxTextBox ID="txtKPIDisplayName" ClientInstanceName="KPI_txtKPIDisplayName"
                            ...
                            <tr>
                                <td colspan="2">
                                    <table class="ds">
                                        <tr runat="server" id="TrDataSource" visible="false">
                                            <th>
                                                Data source
                                            </th>
                                            <td style="padding-bottom: 3px">
                                                <dx:ASPxComboBox ID="cboDatasource" runat="server" AutoPostBack="true" ClientInstanceName="KPI_cboDatasource"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:250px">
                                                <dx:ASPxComboBox ID="cboKPI" runat="server" AutoPostBack="true" ClientInstanceName="KPI_cboKPI"
                                                    OnValueChanged="cbo_ValueChanged" Width="100%">
                                                </dx:ASPxComboBox>
                                            </td>
                                        </tr>
                                ...
                                <td valign="top">
                                    <dx:ASPxButton ID="btnNewKPI" runat="server" AutoPostBack="true" OnClick="btn_Click"
                                        Text="New" Width="50px" />
                                </td>
                                <td>
                                    &nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxComboBox ID="cboCtrlType" runat="server" AutoPostBack="true" ClientInstanceName="KPI_cboCtrlType"
                                        OnValueChanged="cbo_ValueChanged" Width="100%" ShowImageInEditBox="True">
                                    </dx:ASPxComboBox>
                                </td>
                                <td>
                                    Control
                                ...
                                <td style="width: 250px;">
                                    <dx:ASPxComboBox ID="cboCtrl" runat="server" AutoPostBack="false" ClientInstanceName="KPI_cboCtrl"
                                        Height="20px" ShowImageInEditBox="True" Width="100%">
                                    ...
                                    <fieldset style="padding: 3px">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtMinValue" runat="server" AutoPostBack="true" Width="80px" CssClass="numericInput"
                                                        Text="0" />
                                                </td>
                                                <td>
                                                    <dx:ASPxCheckBox ID="chkNoMinValue" runat="server" AutoPostBack="false" Font-Names="Arial"
                                                        Font-Size="10pt" Text="No min value">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtMaxValue" runat="server" AutoPostBack="true" Width="80px" CssClass="numericInput"
                                                        Text="1000" />
                                                </td>
                                                <td>
                                                    <dx:ASPxCheckBox ID="chkNoMaxValue" runat="server" AutoPostBack="false" Font-Names="Arial"
                                                        Font-Size="10pt" Text="No max value">
                                                        <ClientSideEvents CheckedChanged="function(s,e){
                    ...
                    <asp:UpdatePanel ID="upp_Dimension" runat="server">
                        <ContentTemplate>
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="btnAddDimension" runat="server" Text="Add dimension" Width="120px"
                                            OnClick="btn_Click" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <asp:UpdatePanel ID="upp_Measures" runat="server">
                        <ContentTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <div id="ctrl_Measures" runat="server">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <dx:ASPxButton ID="btnAddMeasure" runat="server" Text="Add measures" Width="120px"
                                            OnClick="btn_Click" />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>
                                        <div id="ctrl_KPIFilters" runat="server">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <asp:UpdatePanel ID="upp_ContextMetrics" runat="server">
                        <ContentTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <div id="ctrl_ContextMetric" runat="server">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
    ...
    <tr>
        <td>
            <dx:ASPxButton ID="btnPreview" runat="server" Text="Preview" Width="100px" AutoPostBack="False">
                <ClientSideEvents Click="BtnPreview_Click" />
            </dx:ASPxButton>
        </td>
        <td>
        ...
        <td>
            <dx:ASPxCallbackPanel ID="cbpSavingMsg" ClientInstanceName="KPI_cbpSavingMsg" runat="server"
                Width="100%" OnCallback="cbp_Callback">
                ...
                <PanelCollection>
                    <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                        <asp:UpdatePanel ID="upp_SavingMsg" runat="server">
                            <ContentTemplate>
                                <dx:ASPxLabel ID="lblSavingMsg" runat="server">
                                </dx:ASPxLabel>
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </dx:PanelContent>
...
<!--Content Of Preview-->
<dx:ASPxPopupControl ID="frmPreView" ClientInstanceName="KPI_frmPreView" runat="server"
    AppearAfter="100" CloseAction="CloseButton" DisappearAfter="100" Font-Names="Arial"
                        ...
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl1" runat="server">
                                <dx:ASPxGridView ID="gvPreViewData" ClientInstanceName="KPI_gvPreViewData" runat="server"
                                    AutoGenerateColumns="false" Font-Names="Arial" Font-Size="9pt" Width="100%" OnCustomCallback="gvPreViewData_CustomCallback"
                                    OnPageIndexChanged="gvPreViewData_PageIndexChanged" OnCustomUnboundColumnData="gvPreViewData_CustomUnboundColumnData">
                    ...
                    <dx:TabPage Name="tabCtrl_PreViewSQL" Text="MDX Query" ToolTip="MDX Query">
                        ...
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl2" runat="server">
                                <dx:ASPxCallbackPanel ID="cbpPreViewSQL" ClientInstanceName="KPI_cbpPreViewSQL" runat="server"
                                    Width="100%" OnCallback="cbp_Callback">
                                    <PanelCollection>
                                        <dx:PanelContent ID="PanelContent_PreViewSQL" runat="server" SupportsDisabledAttribute="True">
                                            <dx:ASPxMemo ID="txtPreViewSQL" ReadOnly="true" runat="server" Height="500px" Width="100%">
                                            </dx:ASPxMemo>
                                        </dx:PanelContent>
                                    </PanelCollection>
                                </dx:ASPxCallbackPanel>
